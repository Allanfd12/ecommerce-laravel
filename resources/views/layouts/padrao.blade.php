			...
			<div class="row">
						...
						<div class="topbar-menu right-menu">
							...
							@if (Route::has('login'))
								@auth
										...
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
												...
												<form id="myFormLogout" method="POST" action="{{route('logout')}}">
													@csrf
												<li class="menu-item" >
													<a title="Sair" href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('myFormLogout').submit();">Sair</a>
												</li>
												</form>
											</ul>
										</li>
									@else
									<li class="menu-item menu-item-has-children parent" >
										<a title=">My Account" href="#">My Costumer Account ({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
										<ul class="submenu curency" >
											<li class="menu-item" >
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						@livewire('service.header-search-componet')
