                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{route('product.detail',['slug'=>$popular_product->slug])}}" title="{{$popular_product->name}}">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">{{$this->formater::monetaryValue($popular_product->getPrice())}}</span></div>
                                    </div>
                                </div>
                            </li>
                            @endforeach
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('product.detail',['slug'=>$related_product->slug])}}" title="{{$related_product->name}}">
                                        <figure><img src="{{asset('assets/images/products/'.$related_product->image)}}" width="214" height="214" alt="{{$popular_product->name}}"></figure>
                                    </a>
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price"><span class="product-price">{{$this->formater::monetaryValue($related_product->getPrice())}}</span></div>
                                </div>
                            </div>
                            @endforeach
                        </div>
