                ...
                <div class="wrap-shop-control">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="sort_method">
                            ...
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail"> 
                                    <a href="{{route('product.detail',['slug'=>$product->slug])}}" title="{{$product->name}}">
                                        <figure><img src="{{asset('assets/images/products/'.$product->getImage())}}" alt="{{$product->name}}"></figure>
                                    </a>
                                </div>
                    ...
                    <div class="widget-content">
                        <ul class="list-category">
                            ...
                            <li class="category-item">
                                <a href="{{route('category.detail',['slug'=>$category->slug])}}" class="cate-link">{{$category->name}}</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
